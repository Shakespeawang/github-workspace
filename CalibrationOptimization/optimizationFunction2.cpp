 ...
 bool writeParams(std::string path, std::vector<cv::Mat_<float>> & vec1, std::string flag1, std::vector<cv::Mat_<float>> & vec2, std::string flag2)
{
 ...
 bool readParams(std::string path, std::vector<cv::Mat_<float>> & vec1, cv::Size Size1, std::string flag1, std::vector<cv::Mat_<float>> & vec2, cv::Size Size2, std::string flag2, int n)
{
