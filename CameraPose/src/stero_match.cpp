...
//
//		imwrite(prefix_str + ".stereoRectify.jpg", result);
//
...
//		cv::waitKey(10000);
//
//		cv::destroyWindow(prefix_str + "_stereo_rectify");
//	}
//
...
//
//		imwrite( prefix_str + ".disparity.jpg", disp8);
//
...
//		cv::waitKey(10000);
//		cv::destroyWindow(prefix_str + "_disparity");
//		printf("\n");
//	}
//
