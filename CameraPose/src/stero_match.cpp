...
int main(int argc, char** argv)
{
	...
	std::string extrinsic_filename = "../Debug/extrinsic_opt.yaml";
	std::string disparity_filename = "../Debug/e_disp.jpg";
	...
	if (!intrinsic_filename.empty())
	{
		...
		imwrite(img1_filename + ".rectL.jpg", img1r);
		imwrite(img1_filename + ".rectR.jpg", img2r);
